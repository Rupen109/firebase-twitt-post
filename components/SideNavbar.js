...
function SideNavbar() {
    ...
    return (
        ...
        <div className="">
            {user && (   
                <Disclosure as="nav">
                <Disclosure.Button className="absolute top-4 right-4 inline-flex items-center peer justify-center rounded-md p-2 text-gray-800 hover:bg-gray-900 hover:text-white focus:outline-none ">
                    <GiHamburgerMenu
                        className="block md:hidden h-6 w-6 text-white -mt-4 "
                        aria-hidden="true"
                    />
                </Disclosure.Button>
